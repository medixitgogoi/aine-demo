...
const recruiters = [
  {
    ...
    logo: "/images/highlights/h1.png",
  },
  {
    name: "Fortis Healthcare",
    logo: "/images/highlights/h2.png",
  },
  {
    name: "Max Healthcare",
    logo: "/images/highlights/h1.png",
...
export default function PlacementPartners() {
  return (
    <section
      ...
      className="bg-background-dark/1 pb-28 pt-12 scroll-mt-15"
    >
      <div className="mx-auto max-w-7xl px-6">
        {/* Heading */}
        <div className="mx-auto mt-6 max-w-3xl text-center flex flex-col items-center justify-center">
          <SectionHeader text="Placement Partners" />
        ...
        <div className="mt-20 grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4">
          {recruiters.map((company) => (
            <div
              key={company.name}
              className="group relative overflow-hidden rounded-xl border border-border bg-card p-8 transition-all duration-300 hover:-translate-y-2 hover:border-primary hover:bg-card-hover hover:shadow-xl hover:shadow-gray-200/50"
            >
              {/* Accent Line */}
              <div className="absolute left-0 top-0 h-[2px] w-0 bg-primary transition-all duration-300 group-hover:w-full" />

              <div className="flex h-24 items-center justify-center rounded-lg p-4 transition-colors duration-300 group-hover:bg-gray-100">
                <Image
                  src={company.logo}
                  alt={company.name}
                  width={120}
              ...
              <div className="mt-6 text-center">
                <h3 className="text-base font-semibold text-card-heading transition-colors duration-300 group-hover:text-primary">
                  {company.name}
                </h3>
              </div>
            </div>
...
//       <div className="rounded-2xl border border-border bg-gray-50/50 p-6 transition-colors duration-300 hover:border-primary/30 hover:bg-gray-50">
